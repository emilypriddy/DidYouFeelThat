...
//    self.mapView.delegate = self;
    ...
    // Set nav bar items.
//    self.navController.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Settings"
//                                                                                           style:UIBarButtonItemStylePlain
//                                                                                          target:self
//                                                                                          action:@selector(settingsButtonSelected:)];
//    self.navController.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"Register Quake"
//                                                                                            style:UIBarButtonItemStylePlain
//                                                                                           target:self
...
//    [self.mapClusterControllerRed addAnnotations:self.allQuakes withCompletionHandler:NULL];
}
