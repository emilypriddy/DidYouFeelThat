...
static NSUInteger const DYFTQuakesTableViewMainSection = 0;
...
////    [view addSubview:self.noDataButton];
//
...
- (PFQuery *)queryForTable {
    ...
    CLLocation *currentLocation = [self.dataSource currentLocationForQuakesTableViewController:self];
